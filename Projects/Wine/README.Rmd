...
author: Alef Tenório; Alex Pereira; Guilherme A. Leite & Raphael Prates
output:
  github_document:
    toc: true
---
...
```
# Introdução  
Este trabalho foi realizado na matéria "Conceitos Estatísticos para IA" do curso de MBA em __Artificial Intelligence and Machine Learning__ da FIAP, tendo como objetivo a utilização de técnicas de estatística para exploração de dados e o uso de algoritmos para predição da qualidade dos vinhos.  
...
Vamos utilizar a análise gráfica para reforçar a visualização dos valores já obtidos na função _summary_ (a visualização gráfica por diagramas de caixa nos auxilia também na detecção de outliers):
