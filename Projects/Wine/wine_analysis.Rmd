...
Como as somas dos valores _NA_s, tanto para o vinho tinto quanto para o branco, podemos afirmar que __não há dados faltantes.__ Dessa forma podemos continuar sem precisar substituir ou remover os valores iguais a _NA_.
...
Trabalharemos com os valores das medianas, ao invés das médias, porque as medianas não sofrem o impacto que as médias teriam devido a presença de outliers. Explorando esses dados é possível ter um overview de como essas característica estão organizadas pelo dataset e, também, identificar o que diferece um vinho tinto do branco.  
```{r echo=TRUE, warning=FALSE, message=FALSE}
# Vinho Tinto
