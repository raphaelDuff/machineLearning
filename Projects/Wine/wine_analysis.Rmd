---
title: "Estatística - Análise da qualidade de vinhos"
author: "IA - 04"
date: '`r Sys.Date()`'
output:
  html_document:
...
```{r echo=TRUE, warning=FALSE, message=FALSE}
acpcor <- prcomp(wine_white_dset, scale = TRUE)
summary(acpcor)
plot(1:ncol(wine_white_dset), acpcor$sdev^2, type = "b", xlab = "Componente",
...
Como podemos observar da análise do tópico anterior, os componentes PC1, PC2, PC3 e PC4 se mostram os mais relevantes para a escolha do modelo.
